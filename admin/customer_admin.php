    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="customer_admin.php" class="active"><span class="las la-users"></span>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $customer = mysqli_query($conn, "SELECT * FROM tb_customer WHERE id_customer ORDER BY id_customer DESC LIMIT 10");
                                    if (mysqli_num_rows($customer)) {
                                        while ($c = mysqli_fetch_array($customer)) {
                                    ?>
                                        <tr>
                                            <td><?php echo $c['id_customer']?></td>
                                            <td><?php echo $c['name_customer']?></td>
                                            <td><?php echo $c['username_customer']?></td>
                                            <td><?php echo $c['email_customer']?></td>
                                            <td><?php echo $c['number_customer']?></td>
                                        </tr>
                                    </tbody>
                                <?php }} else { ?>
